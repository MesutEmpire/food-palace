    ...
    <div class="max-w-2xl mx-auto bg-white p-16">
        ...
        <div class="p-4   rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8">
            ...
            <form @submit.prevent="onSubmit">
                <div class="grid gap-6 mb-6 lg:grid-cols-2 ">
                    <div>
                        <label for="first_name"
                            class="block mb-2 text-sm lg:text-base font-medium text-gray-900 ">First name</label>
                    ...
                    <div>
                        <label for="last_name"
                            class="block mb-2 text-sm lg:text-base font-medium text-gray-900 ">Last
                            name</label>
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm lg:text-base font-medium text-gray-900 dark:text-gray-300">Phone
                            number</label>
                ...
                <div class="mb-6">
                    <label for="email" class="block mb-2 text-sm lg:text-base font-medium text-gray-900 dark:text-gray-300">Email
                        address</label>
                ...
                <div class="mb-6">
                    <label for="confirm_password"
                        class="block mb-2 text-sm lg:text-base font-medium text-gray-900 dark:text-gray-300">Confirm password</label>
                ...
                <div v-if="hasError.displayError"    class="p-4 mb-4 text-sm lg:text-base text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
  <span class="font-medium">Incorrect! Password </span> Try Again
</div>

<div v-if="correctPass.displaySuccess" class="p-4 mb-4 text-sm lg:text-base text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">

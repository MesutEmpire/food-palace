<template>
  <!-- <div class=" flex justify-end  w-56 md:w-64  -mt-10 shadow-lg rounded-lg overflow-hidden  z-50 my-4 text-base list-none bg-white  divide-y divide-gray-100  py-3 px-4"
        id="dropdown" data-dropdown-toggle="dropdown">

        <span class="block text-sm text-gray-90"> {{ user.firstname }}</span>
  ...
  <div class="flex justify-end mr-10">
    <div class=" top-0 right-0  w-56 mt-2 origin-top-right rounded-md shadow-lg md:w-48 max-w-auto">
      <div class="px-2 py-2 bg-white rounded-md shadow ">
        <span class="block text-sm text-gray-90"> {{ user.firstname }} {{ user.lastname }}</span>
        <span class="block text-sm font-medium text-gray-500 truncate ">{{ user.email }}</span>
        <ul>
